...
public class MainActivity extends Activity {
	...
	private void initializeAds() {
		...
		adRequest.addKeyword("gomoku");
		adRequest.addKeyword("brain games");
		adRequest.addKeyword("artificial intelligence");
		adRequest.addKeyword("puzzle");
		adRequest.addKeyword("intelligence");
		adRequest.addKeyword("memory");
